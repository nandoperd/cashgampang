        ...
        ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?= base_url('fots') ?>">FOTS</a></li>
                    <li><a href="#">ILW</a></li>
                    <li><a href="#">UBL</a></li>
                    <li><a href="#">TSII</a></li>
                    <!-- <li><a href="#">Borongan</a></li> -->
                </ul>
            </li>

            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Pinjaman Luar PT <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="#">Luar PT</a></li>
            ...
            <li>
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Deposito<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<?= base_url('deposito') ?>">Data Deposito</a></li>
                    <!-- <li><a href="<?= base_url('mapel') ?>">Mata Pelajaran</a></li>
                    <li><a href="<?= base_url('jadwalpelajaran') ?>">Jadwal Pelajaran</a></li> -->
                </ul>
            </li>
        ...
        <?php } elseif (session()->get('level') == 2) { ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?= base_url('halguru/absen_siswa') ?>">Absen Kelas</a></li>
